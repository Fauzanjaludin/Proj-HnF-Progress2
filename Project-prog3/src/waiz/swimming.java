 ...
 * @author USER
 */
public class swimming extends AtGymAerobic1 {
    ...
    public void swimming(){
        ...
        System.out.println("About (Swimming): "+about);
    }
    public void equipment(){
        this.equipment=" Pool, swimsuit, goggles (optional)";
        System.out.println("Equipment(Swimming): "+equipment);
    }
    public void benefits(){
        ...
        System.out.println("Benefits (Swimming): "+benefits);
    }
    public void safety(){
        ...
        System.out.println("Safety (Swimming): "+safety);
    }
    public void duration(){ 
    this.duration=" 10 to 30 minutes";
    System.out.println("Duration (Swimming): "+duration);
    }
    public void frequency(){
     this.frequency=" 2 to 5 times a week";   
     System.out.println("frequency (Swimming): "+frequency);
    }
